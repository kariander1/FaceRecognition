...
class Net(nn.Module):
    def __init__(self, filter_size, pooling_size, num_of_filters, num_of_filters_2):
        ...
        self.conv1 = nn.Conv2d(3, num_of_filters, filter_size)
        self.pool = nn.MaxPool2d(pooling_size, pooling_size)
        self.conv2 = nn.Conv2d(num_of_filters, num_of_filters_2, filter_size)
        self.fc1 = nn.Linear(num_of_filters_2 * 5 * 5, 120)
